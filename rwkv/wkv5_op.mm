...
void forward(
    ...
    @autoreleasepool {      // xzl: ???
        ...
        dispatch_sync(serialQueue, ^(){
            ...
            [computeEncoder setBytes:&B length:sizeof(B) atIndex:0];
            [computeEncoder setBytes:&T length:sizeof(T) atIndex:1];
            [computeEncoder setBytes:&C length:sizeof(C) atIndex:2];
            [computeEncoder setBytes:&H length:sizeof(H) atIndex:3];
